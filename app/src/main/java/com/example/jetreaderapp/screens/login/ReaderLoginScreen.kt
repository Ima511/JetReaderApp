...
import com.example.jetreaderapp.components.ReaderLog
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally,
            ...
            if (showLoginForm.value){
                UserForm(loading = false, isCreateAccount = false){
                        email , pasword ->
                    viewModel.signInWithEmailAndPassword(email = email, password = pasword){
                ...
                // Todo: Create FB account
                    viewModel.createUserWithEmailAndPassword(email,password = password){
                        navController.navigate(ReaderScreens.ReaderHomeScreen.name)
                    }
                }
            }
...
fun SubmitButton(textId: String,
    ...
    else Text( modifier = Modifier.padding(5.dp), text = textId)
